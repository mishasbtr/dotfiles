...
;// CONCATENATED MODULE: ./src/autofill/overlay/pages/button/autofill-overlay-button.ts
var autofill_overlay_button_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
class AutofillOverlayButton extends autofill_overlay_page_element {
    constructor() {
        super();
    ...
    initAutofillOverlayButton({ authStatus, styleSheetUrl, translations, }) {
        return autofill_overlay_button_awaiter(this, void 0, void 0, function* () {
...
/* harmony default export */ const autofill_overlay_button = (AutofillOverlayButton);

;// CONCATENATED MODULE: ./src/autofill/overlay/pages/button/bootstrap-autofill-overlay-button.ts


__webpack_require__(22433);
(function () {
    globalThis.customElements.define(AutofillOverlayElement.Button, autofill_overlay_button);
})();
